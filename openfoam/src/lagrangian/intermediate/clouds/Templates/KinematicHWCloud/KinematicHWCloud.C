...
void Foam::KinematicHWCloud<CloudType>::setModels()
{
    dispersionModel_.reset
    (
        DispersionModel<KinematicHWCloud<CloudType>>::New
        (
            subModelProperties_,
            *this
        ).ptr()
    ...
    (
        PatchInteractionModel<KinematicHWCloud<CloudType>>::New
        (
            subModelProperties_,
            *this
        ).ptr()
    ...
    (
        StochasticCollisionModel<KinematicHWCloud<CloudType>>::New
        (
            subModelProperties_,
            *this
        ).ptr()
    ...
    (
        SurfaceFilmModel<KinematicHWCloud<CloudType>>::New
        (
            subModelProperties_,
            *this
        ).ptr()
...
void Foam::KinematicHWCloud<CloudType>::solve
(
...
template<class CloudType>
void Foam::KinematicHWCloud<CloudType>::buildCellOccupancy()
{
    ...
    forAllIter(typename KinematicHWCloud<CloudType>, *this, iter)
    {
...
template<class CloudType>
void Foam::KinematicHWCloud<CloudType>::updateCellOccupancy()
{
...
template<class CloudType>
template<class TrackCloudType>
void Foam::KinematicHWCloud<CloudType>::evolveCloud
(
    TrackCloudType& cloud,
    typename parcelType::trackingData& td
)
...
template<class CloudType>
void Foam::KinematicHWCloud<CloudType>::postEvolve()
{
    Info<< endl;
...
template<class CloudType>
void Foam::KinematicHWCloud<CloudType>::cloudReset(KinematicHWCloud<CloudType>& c)
{
...
template<class CloudType>
Foam::KinematicHWCloud<CloudType>::KinematicHWCloud
(
...
(
    const fvMesh& mesh,
    const word& name,
    const KinematicHWCloud<CloudType>& c
)
:
...
template<class CloudType>
void Foam::KinematicHWCloud<CloudType>::setParcelThermoProperties
(
    parcelType& parcel,
...
template<class CloudType>
void Foam::KinematicHWCloud<CloudType>::checkParcelProperties
(
    parcelType& parcel,
    const scalar lagrangianDt,
...
template<class CloudType>
void Foam::KinematicHWCloud<CloudType>::storeState()
{
    cloudCopyPtr_.reset
    (
        static_cast<KinematicHWCloud<CloudType>*>
        (
...
template<class CloudType>
void Foam::KinematicHWCloud<CloudType>::restoreState()
{
...
template<class CloudType>
void Foam::KinematicHWCloud<CloudType>::resetSourceTerms()
{
    UTrans().field() = Zero;
    UCoeff().field() = 0.0;
}
...
template<class CloudType>
template<class Type>
void Foam::KinematicHWCloud<CloudType>::relax
(
...
template<class CloudType>
template<class Type>
void Foam::KinematicHWCloud<CloudType>::scale
(
    DimensionedField<Type, volMesh>& field,
    const word& name
) const
...
template<class CloudType>
void Foam::KinematicHWCloud<CloudType>::relaxSources
(
    const KinematicHWCloud<CloudType>& cloudOldTime
)
{
...
template<class CloudType>
void Foam::KinematicHWCloud<CloudType>::scaleSources()
{
...
template<class CloudType>
void Foam::KinematicHWCloud<CloudType>::preEvolve()
{
...
template<class CloudType>
void Foam::KinematicHWCloud<CloudType>::evolve()
{
...
template<class CloudType>
template<class TrackCloudType>
void Foam::KinematicHWCloud<CloudType>::motion
(
    TrackCloudType& cloud,
    typename parcelType::trackingData& td
)
...
template<class CloudType>
void Foam::KinematicHWCloud<CloudType>::patchData
(
    const parcelType& p,
    const polyPatch& pp,
    vector& nw,
...
template<class CloudType>
void Foam::KinematicHWCloud<CloudType>::updateMesh()
{
    updateCellOccupancy();
...
template<class CloudType>
void Foam::KinematicHWCloud<CloudType>::autoMap(const mapPolyMesh& mapper)
{
...
template<class CloudType>
void Foam::KinematicHWCloud<CloudType>::info()
{
